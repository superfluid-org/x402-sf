...
export type {
  Permit2MacroStatus,
  ClearMacroFacilitatorInfo,
  UsePermit2MacroStreamOptions,
  UsePermit2MacroStreamReturn,
} from "./hooks/usePermit2MacroStream.js";
...
export {
  buildClearMacroStreamExecution,
  submitClearMacroExecution,
  createStreamViaClearMacro,
  facilitatorRelay,
  parseEip712Types,
} from "./core/clearMacro.js";
export type {
  ClearMacroExecution,
  BuildClearMacroStreamParams,
  CreateStreamViaClearMacroParams,
} from "./core/clearMacro.js";

// ClearMacro + Permit2: one signature pulls USDC, upgrades to USDCx, opens the stream
export {
  buildPermit2MacroStreamExecution,
  submitPermit2MacroExecution,
  createStreamViaPermit2Macro,
  facilitatorPermit2Relay,
} from "./core/clearMacroPermit2.js";
export { checkPermit2Allowance, approvePermit2 } from "./core/permit2.js";
export type {
  Permit2MacroExecution,
  Permit2MacroContext,
  BuildPermit2MacroStreamParams,
  CreateStreamViaPermit2MacroParams,
} from "./core/clearMacroPermit2.js";
